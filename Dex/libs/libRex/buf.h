...
#if defined(_VISUAL_STUDIO)
/* typedef int pid_t; */
#endif /* _VISUAL_STUDIO */

/*
typedef int16_t snt;
typedef u_int16_t u_snt;
*/
...
/*
 *	MAGIC is a int32_t bit pattern placed in analog headers in
...
typedef struct {
	...
	int		e_key;		/* a 32 bit time; or if this event references
						   an analog record in the A file, a 32 bit
						   address */
} EVENT;
 ...
 * has a int32_t magic number to search for to locate headers in case
...
#define	INT_BLOCK_FIRST	ptbl[0]	/* define to be first member of struct */   
	...
	u_int16_t	evlx;		/* load index for event buf;  point16_ts to next
				   location to load */
